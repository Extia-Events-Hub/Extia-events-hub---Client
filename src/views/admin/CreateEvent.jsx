            ...
            <div className='w-full px-[5%] md:px-[10%] py-[15vh] flex flex-col items-center relative min-h-screen gap-16'>
                <form action="" className='w-full md:w-1/2 flex flex-col gap-4'>
                    <label className='font-mulish text-lg my-2'>
                        Name event:
                        <input type="text" placeholder={"..."} className="input rounded-full shadow-custom w-full font-roboto font-normal p-4" />
                    </label>
                    <label className='font-mulish text-lg my-2'>
                        Short description
                        <textarea placeholder='Descripción corta' className="input rounded-2xl min-h-16 shadow-custom w-full font-roboto font-normal p-4"></textarea>
                    </label>
                    ...
                    <textarea placeholder='Descripción detallada' className="input rounded-2xl min-h-[8rem] shadow-custom w-full font-roboto font-normal p-4"></textarea>
