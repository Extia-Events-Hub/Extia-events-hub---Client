    ...
    <>
      ...
      <div className="w-full px-[5%] md:px-[10%] pt-[15vh] flex flex-col relative min-h-screen gap-8">
        <div className="aspect-video md:aspect-[4/1] w-full rounded-2xl bg-white shadow-custom overflow-hidden">
          <img
            src="https://www.timejust.es/wp-content/uploads/2021/03/eventos.jpg"
            alt="banner_event"
        ...
        <div className="w-full h-full  flex gap-8">
          <div className=" w-full md:w-1/2 flex pb-12  flex-col gap-4">
            ...
            <p>
              ...
              impedit, vero qui minima excepturi earum laudantium numquam animi
              culpa aliquid unde enim ea eaque eum ducimus maxime nam suscipit.
              Laborum?
            </p>
            ...
            <div className="flex flex-col gap-4 font-roboto">
              <p>
                ...
                Blanditiis, non harum rerum laborum tempore aliquid dolor ex,
                voluptates suscipit, voluptatibus id unde perspiciatis possimus
                ut amet? Eligendi fuga ducimus repudiandae?
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Corrupti architecto fugiat minima. Aspernatur sequi laborum
                laboriosam rerum quibusdam nostrum ipsa, nisi ipsum delectus
                dignissimos veritatis consectetur temporibus ducimus obcaecati
                quis.
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
